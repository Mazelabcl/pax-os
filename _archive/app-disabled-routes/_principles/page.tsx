...
export const metadata = {
  title: "Primeros principios — Pax",
  description:
    "El núcleo del proyecto Pax: qué es, cómo funciona, por qué importa. Documento canónico.",
};

export default async function PrinciplesPage() {
  const doc = await readMarkdown("principles.md");
  const toc = extractToc(doc.content, 3);
  const updated = await getLastUpdated("content/principles.md");
